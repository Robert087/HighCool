...
public static class DependencyInjection
{
        ...
        IHostEnvironment hostEnvironment)
    {
        ...
        services.AddScoped<IBackupManifestAuthenticationService, BackupManifestAuthenticationService>();
        services.AddScoped<SqliteDatabaseBackupService>();
        services.AddSingleton<ICloudBackupQueueStore, CloudBackupQueueStore>();
        services.AddScoped<ICloudBackupConfigurationStore, CloudBackupConfigurationStore>();
        services.AddScoped<ICloudBackupProvider, CloudflareR2BackupProvider>();
        services.AddScoped<ICloudBackupWorkflowService, CloudBackupWorkflowService>();
        services.AddScoped<IDatabaseBackupService, CloudAwareDatabaseBackupService>();
        services.AddHostedService<CloudBackupUploadBackgroundService>();
        ...
        services.AddScoped<IInventoryAdjustmentPostingService, InventoryAdjustmentPostingService>();
        services.AddScoped<IInventoryTransferService, InventoryTransferService>();
        services.AddScoped<IInventoryTransferPostingService, InventoryTransferPostingService>();
        services.AddScoped<IInventoryCountService, InventoryCountService>();
        services.AddScoped<IInventoryCountPostingService, InventoryCountPostingService>();
        services.AddScoped<IInventoryIssueService, InventoryIssueService>();
        services.AddScoped<IInventoryIssuePostingService, InventoryIssuePostingService>();
        services.AddScoped<IInventoryMonitoringService, InventoryMonitoringService>();
