...
public sealed class InventoryTransferLineConfiguration : AuditableEntityConfigurationBase<InventoryTransferLine>
{
    protected override void ConfigureAuditableEntity(EntityTypeBuilder<InventoryTransferLine> builder)
    {
        builder.ToTable("inventory_transfer_lines");

        builder.Property(entity => entity.InventoryTransferId)
        ...
        builder.HasIndex(entity => new { entity.InventoryTransferId, entity.LineNo })
            .IsUnique();
