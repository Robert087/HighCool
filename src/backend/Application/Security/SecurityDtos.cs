...
public sealed record FeatureConfigurationDto(
    ...
    bool SalesEnabled,
    bool EmployeesEnabled,
    bool SalariesEnabled,
    bool EmployeeAdvancesEnabled,
    bool ExpensesEnabled,
    bool ReportsEnabled,
    bool NotificationsEnabled,
    bool PriceListsEnabled,
    bool PurchaseOrdersEnabled,
    bool PurchaseReceiptsEnabled,
    bool WarehousesEnabled,
    bool ShortageManagementEnabled,
    bool UomEnabled,
    bool UomConversionEnabled,
    bool InventoryTransfersEnabled,
    bool InventoryAdjustmentsEnabled,
    bool InventoryCountsEnabled,
    bool InventoryIssuesEnabled,
...
public sealed record OrganizationFeatureSettingsDto(
    ...
    bool EnableSales,
    bool EnableEmployees,
    bool EnableSalaries,
    bool EnableEmployeeAdvances,
    bool EnableExpenses,
    bool EnableReports,
    ...
    bool EnableInventoryCounts,
    bool EnableInventoryIssues,
