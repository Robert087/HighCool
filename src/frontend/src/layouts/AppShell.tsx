...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "nav.priceLists", to: "/price-lists", icon: "document" },
      { label: "nav.itemPrices", to: "/item-prices", icon: "statement" },
...
const navigationPermissions: Record<string, string | undefined> = {
  ...
  "/price-lists": Permissions.PricingPriceListView,
  "/item-prices": Permissions.PricingItemPriceView,
...
const navigationFeatures: Record<string, FeatureFlagKey | undefined> = {
  ...
  "/price-lists": "priceListsEnabled",
  "/item-prices": "priceListsEnabled",
